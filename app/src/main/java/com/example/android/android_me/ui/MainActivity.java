...
public class MainActivity extends AppCompatActivity implements ListFragment.OnItemImageClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.android_me_linear_layout) != null) {
            ...
            Button nextButton = findViewById(R.id.button_new_activity);
