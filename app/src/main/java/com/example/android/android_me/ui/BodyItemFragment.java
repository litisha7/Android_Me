...
public class BodyItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootV = inflater.inflate(R.layout.body_image_layout, container, false);

        // get a reference for ImageView
        final ImageView imageView = rootV.findViewById(R.id.body_image_view_id);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putIntegerArrayList(ARRAY_IDS, new ArrayList<>(mIntegerList));
